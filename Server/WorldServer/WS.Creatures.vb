    ...
    Public Class CreatureObject
        ...
        Public Overrides Sub Die(ByRef Attacker As BaseUnit)
            ...
            If Not aiScript Is Nothing Then
                If aiScript.IsMoving AndAlso (timeGetTime - LastMove) < LastMove_Time Then
                    ...
                    positionZ = GetZCoord(positionX, positionY, MapID)
        ...
        Public Sub Initialize()
            ...
            If aiScript Is Nothing Then
                ...
                ElseIf CreatureInfo.CreatureType = UNIT_TYPE.CRITTER Then
                    aiScript = New DefaultAI(Me)
                ElseIf CreatureInfo.cNpcFlags = 0 AndAlso StandState = 0 AndAlso cEmoteState = 0 AndAlso CreatureInfo.Damage.Minimum > 0 AndAlso CreatureInfo.Damage.Maximum > 0 AndAlso CreatureInfo.BaseAttackTime > 0 Then
                    aiScript = New DefaultAI(Me)
                Else
        ...
        Public Sub Destroy(Optional ByVal state As Object = Nothing)
            ...
            If SummonedBy > 0 Then
                If GuidIsPlayer(SummonedBy) AndAlso CHARACTERs.ContainsKey(SummonedBy) Then
                    If CHARACTERs(SummonedBy).OldCritter IsNot Nothing AndAlso CHARACTERs(SummonedBy).OldCritter Is Me Then
                        CHARACTERs(SummonedBy).OldCritter = Nothing
                    End If
                End If
            End If
