...
#Region "Game"
    ...
    Public Function GetClassName(ByRef Classe As Integer) As String
        Select Case Classe
            Case Classes.CLASS_DARK_KNIGHT
                GetClassName = "Dark Knight"
...
#Region "Packets"
    ...
    Public Sub SendAccountMD5(ByRef Client As ClientClass, ByRef Character As CharacterObject)
        Dim SMSG_ACCOUNT_DATA_MD5 As New PacketClass(OPCODES.SMSG_ACCOUNT_DATA_TIMES)
        ...
        Next
        'For i = 1 To 5
        'SMSG_ACCOUNT_DATA_MD5.AddUInt64(0)
        'SMSG_ACCOUNT_DATA_MD5.AddUInt64(0)
        'Next i
