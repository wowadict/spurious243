            ...
            Try
                ...
                For i = 0 To tmpDBC.Rows - 1
                    ...
                    If tmpMap = Map Then
                        ...
                        ResetTime_Raid = tmpDBC.Item(i, 120, DBC.DBCValueType.DBC_INTEGER)
                        ResetTime_Heroic = tmpDBC.Item(i, 121, DBC.DBCValueType.DBC_INTEGER)
                        Expansion = tmpDBC.Item(i, 124, DBC.DBCValueType.DBC_INTEGER)
                        Exit For
                    End If
                Next i
...
#End If
    ...
    Public Sub LoadSpawns(ByVal TileX As Byte, ByVal TileY As Byte, ByVal TileMap As Integer)
        ...
        MysqlQuery.Clear()
        WorldDatabase.Query(String.Format("SELECT * FROM tmpspawnedcorpses WHERE corpse_mapId IN ({0}) AND corpse_positionX BETWEEN '{1}' AND '{2}' AND corpse_positionY BETWEEN '{3}' AND '{4}';", TileMap, MinX, MaxX, MinY, MaxY), MysqlQuery)
        For Each InfoRow As DataRow In MysqlQuery.Rows
        ...
        Next
    End Sub
    Public Sub UnloadSpawns(ByVal TileX As Byte, ByVal TileY As Byte, ByVal TileMap As Integer)
...
#Region "Graveyards"
    ...
    Public Class TGraveyard
        ...
        End Sub
    End Class
    Public Sub GoToNearestGraveyard(ByRef Character As CharacterObject, Optional ByVal Alive As Boolean = False)
