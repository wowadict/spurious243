	...
	Public Module CustomCommands
		...
		Public Sub Start()
            Try
                ...
                MySQL.Query(String.Format("SELECT MAX(sell_group) FROM sells;"), MySQLQuery)
        ...
        Public Sub ParseCreature(ByRef Creature As CreatureInfo, ByVal Line As String)
			try
				...
				If Line.Substring(0, 5) = "sell=" Then
                    ...
                    MySQL.Update(String.Format("INSERT INTO sells (sell_item, sell_count, sell_group) VALUES ({0}, {1} ,{2});", itemID, 0, currentSellGroup))
					Exit Sub
				End If
