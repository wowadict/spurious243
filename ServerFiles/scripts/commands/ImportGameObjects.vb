	...
	Public Module CustomCommands
		...
		Public Sub Start()
            Try
                ...
                MySQL.Query(String.Format("SELECT MAX(loot_group) FROM loots;"), MySQLQuery)
        ...
        Public Sub ParseGameObject(ByRef GameObject As GameObjectInfo, ByVal Line As String)
			try
				...
				If Line.Substring(0, 5) = "loot=" Then
                    ...
                    MySQL.Update(String.Format("INSERT INTO loots (loot_item, loot_chance, loot_group) VALUES ({0}, {1} ,{2});", lootEntry, Str(lootChance), currentLootGroup))
					Exit Sub
				End If
