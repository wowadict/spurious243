	...
	Public Module CustomCommands
		...
		Public Sub ParseWorldObject()
				...
				if spawn_type=3 and spawn_count>0 then
					...
					'TODO: Save equips
                Dim MySQLQuery As String = "INSERT INTO spawns (spawn_entry,spawn_time,spawn_positionX,spawn_positionY,spawn_positionZ,spawn_orientation,spawn_spawned,spawn_waypoints,spawn_range,spawn_type,spawn_map,spawn_left)  VALUES ("
