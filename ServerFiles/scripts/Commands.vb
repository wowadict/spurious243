...
Namespace Scripts
	Public Module CustomCommands
        ...
        '            Database.Update("UPDATE accounts SET banned = 1 WHERE account = """ & CType(Character.Value, CharacterObject).Client.Account & """;")
        ...
        '        charactersLock_.ReleaseReaderLock()
        '        Database.Update("UPDATE accounts SET banned = 1 WHERE account = """ & CHARACTERs(GUID).Client.Account & """;")
